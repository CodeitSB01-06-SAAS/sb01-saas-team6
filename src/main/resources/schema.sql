...
-- 제약 조건
-- user(1) -> clothes(N)
ALTER TABLE clothes ADD CONSTRAINT fk_clothes_owner FOREIGN KEY (owner_id) REFERENCES users (id) ON DELETE CASCADE;

-- clothes(1) -> clothes_attributes(N)
ALTER TABLE clothes_attributes ADD CONSTRAINT fk_clothes_attributes_clothes FOREIGN KEY (clothes_id) REFERENCES clothes(id) ON DELETE CASCADE;

-- attributes_defs(1) -> clothes_attributes(N)
ALTER TABLE clothes_attributes ADD CONSTRAINT fk_clothes_attributes_attributes FOREIGN KEY (attribute_id) REFERENCES attributes_defs (id) ON DELETE CASCADE;
